...
echo ""
echo "Add Motorist form now matches the aligned layout used by Add Motorbike / Send Receipt."
echo "Run: npm run deploy  (or: bash deploy.sh if you're using the wrapper script)"
